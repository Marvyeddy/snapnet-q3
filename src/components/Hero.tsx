    ...
    <section className="relative">
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between max-w-[1172px] w-full px-4 sm:px-6 lg:px-[60px] mx-auto gap-8 md:gap-12 mt-12 md:mt-24">
        <div className="flex-1 w-full">
          ...
          <p className="w-full max-w-[449px] text-[#A9A9A9] mt-[18px] md:mt-[28px] mb-[32px] md:mb-[44px] text-center lg:text-left mx-auto lg:mx-0 text-[16px] md:text-[18px] lg:text-[20px] leading-relaxed px-1 md:px-0">
          ...
          <div className="inline-flex flex-col items-center lg:items-start w-full lg:w-[241px]">
            ...
            <div className="h-1 mx-auto bg-[#27AE60] w-[40px] md:w-[55px] lg:w-[69.5px] rounded mt-2"></div>
          </div>
        </div>
        ...
        <div className="flex-1 flex justify-center w-full mb-8 lg:mb-0 max-md:hidden">
          <img
            ...
            alt="hero"
            loading="lazy"
            className="object-contain w-full max-w-[250px] md:max-w-[320px] lg:max-w-[400px] transition-all"
          />
        </div>
      </div>
